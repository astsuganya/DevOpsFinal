...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-8j=97bq!+qzt)$0fgyy-kr7$=a*6g^c3^-)(x1l+c%4mb(_)nz')
...
# Override with dj-database-url (Render Postgres) if provided in environment
...
if os.environ.get('CLOUDINARY_CLOUD_NAME'):
    ...
    MEDIA_URL = '/media/'   # Cloudinary will override this automatically
else:
    MEDIA_URL = '/media/'
